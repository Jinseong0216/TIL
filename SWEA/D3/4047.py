...
영준이가 하는 카드 게임에는 한 덱의 카드가 필요한데 여기서 얘기하는 “한 덱”이란 
스페이드, 다이아몬드, 하트, 클로버 무늬 별로 각각 A, 2~10, J, Q, K의 라벨 즉 4개의 무늬 별로
...
[Example]
S01D02H03H04 -> 12 12 11 13
'''
str1 = '사과는 영어로 apple'
str2 = '바나나는 영어로 banana'
str3 = '키위는 영어로 kiwi'

for sentence in [str1,str2,str3]: print(sentence)
